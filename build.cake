...
var xunit = "test/Nancy.Serialization.ProtoBuf.Tests/bin/" + configuration + "/net452/unix-x64/dotnet-test-xunit.exe";
...
Task("Package")
    ...
    {
        var package =
            outputPackages + File("Nancy.Serialization.ProtoBuf-Latest.zip");
    ...
    .Does(() =>
    {
        ...
        else
        {
            ...
            var settings = new ProcessSettings {
                Arguments = xunit + " " + "test/Nancy.Serialization.ProtoBuf.Tests/bin/"+configuration+"/net452/unix-x64/Nancy.Serialization.ProtoBuf.Tests.dll"
            };
            ...
            using(var process = StartAndReturnProcess("mono", settings))
            {
                ...
                {
                    throw new Exception("Nancy.Serialization.ProtoBuf.Tests failed.");
                }
            }
        }
    });
...
Task("Update-Version")
    ...
    .Does(() =>
    {
        ...
        UpdateProjectJsonVersion(version, "src/Nancy.Serialization.ProtoBuf/project.json");
    });
